...
set CLASSPATH=%APP_HOME%\lib\test.jar;%APP_HOME%\lib\testng-6.9.10.jar;%APP_HOME%\lib\jcommander-1.48.jar;%APP_HOME%\lib\bsh-2.0b4.jar

@rem Execute test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEST_OPTS%  -classpath "%CLASSPATH%" first.pkg.test.MyFirstProg %CMD_LINE_ARGS%
